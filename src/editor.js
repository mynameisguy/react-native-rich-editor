...
<script>
    ...
    (function (exports) {
        ...
        var Actions = {
            ...
            heading1: { result: function() { return queryCommandValue(formatBlock) === 'h1' ? exec(formatBlock, '<p>') : exec(formatBlock, '<h1>'); }},
            heading2: { result: function() { return queryCommandValue(formatBlock) === 'h2' ? exec(formatBlock, '<p>') : exec(formatBlock, '<h2>'); }},
            heading3: { result: function() { return queryCommandValue(formatBlock) === 'h3' ? exec(formatBlock, '<p>') : exec(formatBlock, '<h3>'); }},
            heading4: { result: function() { return queryCommandValue(formatBlock) === 'h4' ? exec(formatBlock, '<p>') : exec(formatBlock, '<h4>'); }},
            heading5: { result: function() { return queryCommandValue(formatBlock) === 'h5' ? exec(formatBlock, '<p>') : exec(formatBlock, '<h5>'); }},
            heading6: { result: function() { return queryCommandValue(formatBlock) === 'h6' ? exec(formatBlock, '<p>') : exec(formatBlock, '<h6>'); }},
